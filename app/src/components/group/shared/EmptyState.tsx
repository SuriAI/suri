      ...
      <div className="flex flex-col items-center justify-center space-y-3 text-center">
        ...
        {action && (
          <button
            ...
            className="px-4 py-2 text-xs bg-white/[0.05] hover:bg-white/[0.08] border border-white/[0.1] rounded text-white/70 hover:text-white/90 transition-colors flex items-center gap-2 active:scale-95"
          >
