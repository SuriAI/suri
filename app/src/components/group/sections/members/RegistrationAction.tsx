      ...
      <AnimatePresence mode="wait" initial={false}>
        {!isRegistered ?
          <motion.button
            ...
            className="rounded-lg border border-cyan-500/50 bg-cyan-500/10 px-3.5 py-1.5 text-[11px] font-bold tracking-wide text-cyan-400 transition-all hover:bg-cyan-500 hover:text-black active:scale-95">
            Register
          </motion.button>
        : <motion.div
