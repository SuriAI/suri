              ...
              <div className="flex w-full max-w-4xl items-center justify-between px-4">
                <div className="w-32">
                  <button
                    ...
                    className="group flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[11px] font-medium text-white/65 backdrop-blur-md transition-all hover:border-white/20 hover:bg-white/10 hover:text-white"
