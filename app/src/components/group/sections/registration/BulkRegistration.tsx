          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 rounded-3xl border border-amber-500/30 bg-black/90 p-6 min-w-[360px] max-w-[95%] intro-y shadow-[0_20px_50px_rgba(0,0,0,0.7)]">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 text-[11px] font-medium transition-all"
              >
                Cancel
              </button>
              {pendingDuplicates.newFiles.length > 0 && (
                <button
                  ...
                  className="flex-1 px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white hover:bg-white/20 text-[11px] font-medium transition-all"
                >
                  Skip
                </button>
              )}
              <button
                ...
                className="flex-1 px-4 py-2 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-500 hover:bg-amber-500/20 text-[11px] font-medium transition-all"
              >
                Add Anyway
              </button>
            </div>
