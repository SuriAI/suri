          ...
          <div className="intro-y absolute top-1/2 left-1/2 z-50 max-w-[95%] min-w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-3xl border border-amber-500/30 bg-black/90 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.7)]">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-[11px] font-medium text-white/60 transition-all hover:bg-white/10 hover:text-white">
                Cancel
              </button>
              {pendingDuplicates.newFiles.length > 0 && (
                <button
              ...
              <button
                ...
                className="flex-1 rounded-lg border border-amber-500/20 bg-amber-500/10 px-4 py-2 text-[11px] font-medium text-amber-500 transition-all hover:bg-amber-500/20">
                Add Anyway
              </button>
            </div>
          </div>
