      ...
      <div className="overflow-hidden rounded-lg border border-white/10 bg-white/5">
        ...
        <div className="px-6 py-4">
          <button
            ...
            disabled={isLoading}
            className="flex items-center gap-2 rounded-lg border border-cyan-500/25 bg-cyan-500/10 px-4 py-2 text-xs font-semibold text-cyan-400 transition-all hover:bg-cyan-500/20 disabled:cursor-not-allowed disabled:opacity-40">
        ...
        <div className="space-y-3 px-6 py-4">
          ...
          <div className="space-y-3 border-t border-white/5 pt-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-2 rounded-lg border border-amber-500/15 bg-amber-500/5 px-4 py-2 text-[10px] font-medium text-amber-400/70 transition-all hover:bg-amber-500/10 disabled:cursor-not-allowed disabled:opacity-40">
