            ...
            <div className="w-full px-4 py-3 flex items-center justify-between hover:bg-white/5 transition-colors">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0 text-left space-y-1">
                        ...
                        {/* Group Description */}
                        {editingGroup?.groupId === group.id && editingGroup.field === "description" ? (
                            <input
                                type="text"
                                value={editValue}
                                onChange={(e) => onEditValueChange(e.target.value)}
                                onBlur={() => onSaveGroupEdit(group.id, "description", editValue)}
                            ...
                            >
                                {group.description || <span className="text-white/30 italic">No description</span>}
                            </div>
                        )}
                    </div>
                </div>
