...
export function Menu({ onBack, initialSection }: MenuProps) {
  ...
  return (
    <div className="pt-10 h-screen bg-gradient-primary text-white flex flex-col">
      {/* Header */}
      <header className="px-6 py-4 border-b border-white/10 glass-card">
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-hidden bg-gradient-secondary">
